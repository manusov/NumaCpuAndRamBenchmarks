...
; System control
; MAXIMUM_MEMORY  = 01001000h      ; 16MB + 4KB aligned, for limited version
; MAXIMUM_MEMORY  = 40001000h      ; 1GB + 4KB aligned request
MAXIMUM_MEMORY  = 80001000h        ; 2GB + 4KB aligned request
CONST_RAM_BLOCK = 32*1024*1024     ; 32GB one tested RAM block
...
sub rsp,8*5
;--- Load optional system functions, this for Win XP (x64) compatibility ---
...
;---
; mov [MemoryRequestSize],MAXIMUM_MEMORY   ; changes from v0.94, fix overflow
...
BasePointCode:
;---
include 'mpetargets\read_mov64.inc'
include 'mpetargets\write_mov64.inc'
include 'mpetargets\copy_mov64.inc'
include 'mpetargets\modify_not64.inc'
include 'mpetargets\write_stosq.inc'
include 'mpetargets\copy_movsq.inc'
include 'mpetargets\read_sse128.inc'
include 'mpetargets\write_sse128.inc'
include 'mpetargets\copy_sse128.inc'
include 'mpetargets\read_avx256.inc'
include 'mpetargets\write_avx256.inc'
include 'mpetargets\copy_avx256.inc'
include 'mpetargets\read_avx512.inc'
include 'mpetargets\write_avx512.inc'
include 'mpetargets\copy_avx512.inc'
include 'mpetargets\dot_fma256.inc'
include 'mpetargets\dot_fma512.inc'
include 'mpetargets\ntwrite_avx256.inc'   ; NT means Non-Temporal store
include 'mpetargets\ntwrite_avx512.inc'
include 'mpetargets\ntwrite_sse128.inc'
include 'mpetargets\ntcopy_avx256.inc'
include 'mpetargets\ntcopy_avx512.inc'
...
include 'mpetargets\ntdot_fma256.inc'
include 'mpetargets\ntdot_fma512.inc'
;--- Additional routines for support non-temporal read, from v0.93 ---
...
;--- Data section ---
; For save file space, first locate initialized variables. 
...
;- Skipped from v0.94
; RevisionID  DB  'Engineering sample v0.94',0Ah,0Dh
;             DB  'PROGRAM IS UNDER DEVELOPMENT.',0

;- Changed from v0.94
; AboutCap    DB  'Program info',0
; AboutID     DB  'NUMA CPU&RAM Benchmarks for Win64', 0Ah,0Dh    ; ,0Ah,0Dh
;             DB  'Engineering sample v0.94',          0Ah,0Dh    ; ,0Ah,0Dh
;             DB  '(C)2018 IC Book Labs',              0Ah,0Dh,0  ; ,0Ah,0Dh,0
...
include 'datavisual\warnsampstr.inc'   ; Str. for warn. about engineering sample 
...
include 'datavisual\drawvars.inc'      ; Variables for Window 1 - benchmarks draw. 
